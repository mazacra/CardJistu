...
void Afficher::afficherRoundTurn(int i)
{
	std::cout << "P" << i << " choisis sa carte" << std::endl << std::endl << std::endl;
}
...
void Afficher::winner(int i)
{
	...
	if (i == 1)
		std::cout << " ____                                         _                               __\n" << "|  _ \\                                       (_) 	                     /_ |\n" << "| |_) |_ ___ _ ___   _____     __ _ _   _     _  ___  _   _  ___ _   _ _ __   | |\n" << "|  _ <| '__/ _` \\ \\ / / _ \\   / _` | | | |   | |/ _ \\| | | |/ _ \\ | | | '__|  | |\n" << "| |_) | | | (_| |\\ V / (_) | | (_| | |_| |   | | (_) | |_| |  __/ |_| | |     | |\n" << "|____/|_|  \\__,_| \\_/ \\___/   \\__,_|\\__,_|   | |\\___/ \\__,_|\\___|\\__,_|_|     |_|\n" << "	                                    _/ |\n" << "	                                   |__/" << std::endl;
	else
		std::cout << " ____                                         _                               ___\n" << "|  _ \\                                       (_) 	                    | __ \\\n" << "| |_) |_ __ __ ___   _____     __ _ _   _     _  ___  _   _  ___ _   _ _ __     ) |\n" << "| _ < | '__/ _` \\ \\ / / _ \\   / _` | | | |   | |/ _ \\| | | |/ _ \\ | | | '__|   / /\n" << "| |_) | | | (_| |\\ V / (_) | | (_| | |_| |   | | (_) | |_| |  __/ |_| | |     / /_\n" << "|____/|_|  \\__,_| \\_/ \\___/   \\__,_|\\__,_|   | |\\___/ \\__,_|\\___|\\__,_|_|    |____|\n" << "	                                    _/ |\n" << "	                                   |__/"
